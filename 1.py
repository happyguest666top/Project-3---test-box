...
img_back = "istockphoto-1221129797-612x612.jpg"
img_hero = "png-clipart-deadpool-illustration-deadpool-wolverine-hulk-marvel-comics-deadpool-icon-comics-superhero-thumbnail.png"
img_bullet = "bullet (1).png"
img_enemy = "3d-unidentified-object-isolated-on-transparent-illustration_548887-47-removebg-preview.png"
score = 0
lost = 0
max_lost = 3
...
mixer.init()
mixer.music.load("film-i-televizionnaya-igra-chtobyi-voyti-v-velikolepnuyu-atmosferu-37464.mp3")
mixer.music.play()
fire_sound = mixer.Sound("korotkaya-ochered-iz-avtomata.mp3")
reload_music = mixer.Sound("byistraya-perezaryadka-orujiya.mp3")
font.init()
